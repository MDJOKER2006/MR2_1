# MY TELEGRAM CHANNEL @SHAHI JOKER 
# MY TELEGRAM GROUP @MRJOKER
#MY GITHUB HTTPS://GITHUB.COM/RAYEESJOKER538 
#THIS SCRIPT FREE 
...
def youtube():
	...
	os.system("xdg-open https://youtube.com/@JOKERatx7159")
	menu()
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY RAYEES JOKER'
        print '\x1b[1;92m THISE SCRIPT CREATED BY RAYEES JOKER'
